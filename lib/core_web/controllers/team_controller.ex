defmodule CoreWeb.TeamController do
  ...
  def edit(conn, %{"id" => id}) do
    ...
    case Core.Accounts.can_access_team(Pow.Plug.current_user(conn), team, "scope", "admin") do
      true ->
        changeset = Accounts.change_team(team)
  ...
  def delete(conn, %{"id" => id}) do
    team = Accounts.get_team!(id) |> Core.Repo.preload([:memberships])
    case Core.Accounts.can_access_team(Pow.Plug.current_user(conn), team, "scope", "admin") do
      true ->

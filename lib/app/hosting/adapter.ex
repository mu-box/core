defmodule App.Hosting.Adapter do
  ...
  def changeset(adapter, attrs) do
    adapter
    |> cast(attrs, [:global, :endpoint, :unlink_code, :api, :name, :server_nick_name, :default_region, :default_size, :can_reboot, :can_rename, :internal_iface, :external_iface, :ssh_user, :ssh_auth_method, :ssh_key_method, :bootstrap_script, :instructions])
    |> validate_required([])
  end
end
